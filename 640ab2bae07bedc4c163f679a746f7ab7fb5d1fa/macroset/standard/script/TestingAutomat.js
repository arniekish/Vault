...
function start_test_engine(profile, pa_project, delay, steps) {
    ...
    new TestingAutomat().Start(steps, profile, delay);
...
TestingAutomat.prototype.Start = function (states, profile, delay) {
