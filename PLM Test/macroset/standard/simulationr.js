...
var string_templates = {
    explanation_long_nav_forw:
        ...
        '<a role="button" tabindex="1" href="javascript:ctx.cfg_show(\'trigger!page.task_next\');" title="Next" style="cursor:pointer;vertical-align:top;margin:1px;">$%{g_linktextpraxis}</a>' +
        '</div></li>' +
        '</ul>',
    ...
    bubbletext_d_nav:
        '$%{explanation_d}<div style="text-align:right;white-space:nowrap;">' +
        '<a role="button" tabindex="1" href="javascript:ctx.cfg_show(\'trigger!page.task_next\');" title="Next" style="cursor:pointer;vertical-align:top;margin:1px;">$%{g_linktextpraxis}</a></div>'
};  // string_templates
...
var MacroCtlCreator = {
    ...
    Highlight: function(c, params, sub_id, z, target_id /*, effect*/) {
        ...
        return {
            ...
            ignore_target: !overlay && (cfg.c || target_id == null),
            hl_type: tpe,
...
MacroRenderer.new_page = function(c, params) {
    ...
    if (bimgs) {
        ...
        images = {id: imgsrc, w: page_w, h: page_h};
    }
...
function prepare_macro_(c, mac_type, mac) {
    ...
    if (isValid) {
        ...
        showOverlay = typeof showOverlay === 'boolean' ? showOverlay : c.global_params.g_show_focus_layer;
        if (showOverlay) {  // config param check
            mac.hl_overlay = MacroCtlCreator.Highlight(c, {uid: p.uid, overlay: true}, '_overlay', 900, mac.ctl.id);
